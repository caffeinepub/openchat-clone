import { k as createLucideIcon, j as jsxRuntimeExports, X, r as reactExports, F as useGetReactions, o as Link$1, A as AvatarBubble, H as Trash2, f as useUploadFile, J as useGetMessages, K as useGetCatalogMessages, N as useGetPostReplies, O as useGetTypingUsers, Q as useGetCatalogTypingUsers, R as useGetFeedTypingUsers, V as useGetPinnedMessages, W as useGetPinnedCatalogMessages, Y as useSendMessage, Z as useSendMediaMessage, _ as useDeleteMessage, $ as useEditMessage, a0 as usePinMessage, a1 as useUnpinMessage, a2 as useSetTyping, a3 as useAddReaction, a4 as useRemoveReaction, a5 as useSendCatalogMessage, a6 as useDeleteCatalogMessage, a7 as useEditCatalogMessage, a8 as usePinCatalogMessage, a9 as useUnpinCatalogMessage, aa as useSetCatalogTyping, ab as useAddCatalogReaction, ac as useRemoveCatalogReaction, ad as useAddReply, ae as useDeleteFeedReply, af as useEditFeedReply, ag as usePinFeedReply, ah as useUnpinFeedReply, ai as useSetFeedTyping, aj as useAddFeedReaction, ak as useRemoveFeedReaction } from "./index-D6YLhRqz.js";
import { S as Send } from "./send-CNhaVn4j.js";
/**
...
function LinkPreviewBanner({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        preview.imageUrl && /* @__PURE__ */ jsxRuntimeExports.jsx(
          "img",
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[13px] font-mono text-primary uppercase tracking-wider truncate", children: preview.domain }),
          preview.title && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[13px] font-semibold text-foreground leading-tight mt-0.5 line-clamp-1", children: preview.title }),
          preview.description && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[13px] text-muted-foreground mt-0.5 line-clamp-2 leading-relaxed", children: preview.description })
        ] }),
...
function LinkMessageBubble({ link, isOwn }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "a",
    {
      href: link.url,
      ...
      className: `block max-w-xs rounded-2xl overflow-hidden border transition-smooth hover:opacity-90 ${isOwn ? "rounded-br-sm border-primary/30 bg-primary/10" : "rounded-bl-sm border-border bg-card"}`,
      "data-ocid": "link-message-bubble",
      children: [
        link.imageUrl && /* @__PURE__ */ jsxRuntimeExports.jsx(
          "img",
          {
            src: link.imageUrl,
            alt: "",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-3 py-2.5 space-y-0.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(ExternalLink, { className: "w-3 h-3 flex-shrink-0 text-primary" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[13px] font-mono text-primary truncate", children: (() => {
              try {
          ...
          link.title && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[13px] font-semibold text-foreground leading-snug line-clamp-2", children: link.title }),
          link.description && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[13px] text-muted-foreground leading-relaxed line-clamp-2", children: link.description }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[13px] text-primary/70 truncate pt-0.5", children: link.url })
        ] })
      ]
    }
  );
...
function MediaPreview({ media, onRemove }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        media.kind === "image" ? /* @__PURE__ */ jsxRuntimeExports.jsx(
          "img",
          {
        ...
        ) : media.kind === "video" ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-28 h-28 flex flex-col items-center justify-center gap-2 px-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Film, { className: "w-7 h-7 text-primary" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] text-muted-foreground text-center truncate w-full", children: media.file.name })
        ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-28 h-20 flex flex-col items-center justify-center gap-2 px-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Mic, { className: "w-7 h-7 text-primary" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] text-muted-foreground text-center truncate w-full", children: media.file.name })
        ] }),
        isUploading && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-0 bg-background/70 flex flex-col items-center justify-center gap-1.5", children: [
...
function TypingIndicator({ typingUsers }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: isVisible && /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.div,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-end gap-0.5 h-4", children: [0, 1, 2].map((i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          motion.span,
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[13px] text-muted-foreground italic", children: [
...
function useTimer$1(running) {
  ...
  reactExports.useEffect(() => {
    if (running) {
      ...
      const tick = () => {
        setElapsed(
          Math.floor((Date.now() - (startRef.current ?? Date.now())) / 1e3)
        );
...
function captureThumbnailBlob(videoEl) {
  return new Promise((resolve) => {
    try {
      ...
      canvas.toBlob((blob) => resolve(blob ?? void 0), "image/jpeg", 0.7);
    } catch {
      resolve(void 0);
    }
  });
...
function VideoRecorder({
  ...
  const [camState, setCamState] = reactExports.useState("idle");
  const [errorMsg, setErrorMsg] = reactExports.useState("");
  const [previewBlob, setPreviewBlob] = reactExports.useState(null);
  const [thumbnailBlob, setThumbnailBlob] = reactExports.useState();
  const [thumbnailPreviewUrl, setThumbnailPreviewUrl] = reactExports.useState();
  const [finalDuration, setFinalDuration] = reactExports.useState(0);
  ...
  const revokePreview = reactExports.useCallback(() => {
    ...
    if (thumbnailPreviewUrl) {
      ...
      setThumbnailPreviewUrl(void 0);
    }
  }, [thumbnailPreviewUrl]);
  const handleOpenCamera = reactExports.useCallback(async () => {
    if (disabled) return;
    setErrorMsg("");
    try {
      ...
      onStateChange == null ? void 0 : onStateChange(true);
  ...
  reactExports.useEffect(() => {
    if ((camState === "viewfinder" || camState === "recording") && videoRef.current && streamRef.current) {
  ...
  const handleStartRecording = reactExports.useCallback(() => {
    ...
    recorder.onstop = async () => {
      ...
      const thumb = videoRef.current ? await captureThumbnailBlob(videoRef.current) : void 0;
  ...
  const handleStopRecording = reactExports.useCallback(() => {
    var _a;
  ...
  const handleSend = reactExports.useCallback(() => {
    ...
    revokePreview();
    setPreviewBlob(null);
    setThumbnailBlob(void 0);
    setCamState("idle");
    onStateChange == null ? void 0 : onStateChange(false);
  }, [
    previewBlob,
    finalDuration,
    thumbnailBlob,
  ...
  if (camState === "error") {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(VideoOff, { className: "w-4 h-4 flex-shrink-0" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "flex-1", children: errorMsg }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-x-0 bottom-0 px-4 py-3 bg-gradient-to-t from-black/70 to-transparent flex items-center gap-3", children: [
            camState === "recording" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5", children: [
            ...
            camState === "viewfinder" ? /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                type: "button",
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-5 h-5 rounded-full bg-white" })
              }
            ) : /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-5 h-5 rounded-sm bg-white" })
              }
            )
          ] })
        ]
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute top-2 left-2 px-2 py-0.5 rounded-full bg-black/60 text-white text-[10px] font-mono tabular-nums", children: [
          String(Math.floor(finalDuration / 60)).padStart(2, "0"),
          ":",
          String(finalDuration % 60).padStart(2, "0")
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-x-0 bottom-0 px-4 py-3 bg-gradient-to-t from-black/70 to-transparent flex items-center gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/80 text-xs font-display font-medium flex-1", children: "Video recorded" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
...
function VoiceRecorder({
  ...
  if (state === "error") {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(MicOff, { className: "w-4 h-4 flex-shrink-0" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "flex-1", children: errorMsg }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
  ...
  if (state === "recording") {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "relative flex h-3 w-3 flex-shrink-0", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "relative inline-flex rounded-full h-3 w-3 bg-destructive" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-display font-semibold text-destructive flex-shrink-0", children: "Recording…" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "span",
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-3.5 h-3.5 rounded-sm bg-current" })
            }
          )
        ]
      }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-7 h-7 rounded-lg bg-primary/20 flex items-center justify-center flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Mic, { className: "w-3.5 h-3.5 text-primary" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-display font-semibold text-foreground truncate", children: "Voice message" }),
...
function detectUrl(text) {
  ...
  return (matches == null ? void 0 : matches[0]) ?? null;
}
...
function DropZoneOverlay({ active }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-16 rounded-2xl bg-card border border-primary/30 flex items-center justify-center mb-3 shadow-lg", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Image, { className: "w-8 h-8 text-primary" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-semibold text-foreground text-sm", children: "Drop files to send" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-1", children: "Images · Videos · Audio" })
      ]
    }
  );
}
function ChatComposeBar({
  ...
  const [linkDismissed, setLinkDismissed] = reactExports.useState(false);
  const [fileError, setFileError] = reactExports.useState(null);
  const [isDragOver, setIsDragOver] = reactExports.useState(false);
  const [recordingMode, setRecordingMode] = reactExports.useState("none");
  ...
  const handleFileSelected = reactExports.useCallback(
    async (file) => {
      ...
      try {
        ...
        setPendingMedia(
          (prev) => prev ? { ...prev, progress: 100, uploadedUrl: permanentUrl } : null
        );
      } catch (uploadErr) {
  ...
  const handleVoiceSend = reactExports.useCallback(
  ...
  const handleVideoSend = reactExports.useCallback(
  ...
  const handleRecordingCancel = reactExports.useCallback(() => {
    setRecordingMode("none");
  }, []);
  const isUploading = pendingMedia !== null && pendingMedia.progress < 100;
  const canSend = !isUploading && !isSending && (!!text.trim() || !!(pendingMedia == null ? void 0 : pendingMedia.uploadedUrl));
  const handleSend = reactExports.useCallback(async () => {
    ...
    if (pendingMedia == null ? void 0 : pendingMedia.uploadedUrl) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(DropZoneOverlay, { active: isDragOver }),
        recordingMode === "video" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          VideoRecorder,
          {
            disabled: false,
        ...
        pendingMedia && /* @__PURE__ */ jsxRuntimeExports.jsx(
          MediaPreview,
          {
            media: pendingMedia,
            onRemove: () => {
        ...
        linkPreview && !linkDismissed && /* @__PURE__ */ jsxRuntimeExports.jsx(
          LinkPreviewBanner,
          {
            preview: linkPreview,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(TypingIndicator, { typingUsers }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-end gap-2 mt-1", children: [
          !isRecording && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-0.5 flex-shrink-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              AttachButton,
              {
                icon: Image,
            ...
            onSendLink && /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                type: "button",
                onClick: () => {
                  const url = window.prompt("Enter URL");
                  if (url == null ? void 0 : url.trim()) onSendLink(url.trim(), text.trim());
                },
                disabled: isUploading || isSending,
          ...
          recordingMode === "voice" ? /* @__PURE__ */ jsxRuntimeExports.jsx(
            VoiceRecorder,
            {
              disabled: false,
          ...
          ) : recordingMode === "video" ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 flex items-center px-3 h-10 rounded-xl border border-primary/30 bg-primary/5 text-xs text-muted-foreground font-display", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-2 h-2 rounded-full bg-destructive animate-pulse mr-2 flex-shrink-0" }),
            "Video recording…"
          ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx(
            "textarea",
            {
          ...
          recordingMode === "none" && /* @__PURE__ */ jsxRuntimeExports.jsx(
            VoiceRecorder,
            {
              disabled: isUploading || isSending,
              onSend: handleVoiceSend,
        ...
        !isRecording && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-[10px] text-muted-foreground/40 mt-1.5 ml-1 select-none", children: [
          "Enter to send · Shift+Enter for new line · Drag & drop files to attach",
          isUploading && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ml-2 text-primary animate-pulse", children: "Uploading…" })
        ] })
      ]
    }
  );
...
function MessageReactions({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { initial: false, children: reactions.map((group) => {
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.button,
          {
            ...
            className: `inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[13px] border transition-colors-fast select-none ${hasReacted ? "bg-primary/20 border-primary/40 text-primary font-medium" : "bg-muted/60 border-border/60 text-muted-foreground hover:bg-muted hover:border-border"}`,
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm leading-none", children: group.emoji }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono tabular-nums", children: group.count })
            ]
          },
          group.emoji
        );
...
function ReactionPicker({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: visible && /* @__PURE__ */ jsxRuntimeExports.jsx(
    motion.div,
    {
      ...
      className: `absolute z-20 bottom-full mb-1.5 flex items-center gap-0.5 bg-card border border-border rounded-full px-2 py-1 shadow-lg ${isOwn ? "right-0" : "left-0"}`,
      "data-ocid": "reaction-picker",
      children: QUICK_EMOJIS.map((emoji) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          type: "button",
          onClick: (e) => {
...
function formatTime(ts) {
  ...
  if (typeof ts === "bigint") {
    if (ts <= 0n) return "";
    ms = ts > 1000000000000000n ? Number(ts / 1000000n) : Number(ts);
  } else {
    if (ts <= 0) return "";
    ms = ts;
  }
...
function InlineEdit({
  ...
  const [value, setValue] = reactExports.useState(initialText);
  const ref = reactExports.useRef(null);
  reactExports.useEffect(() => {
    var _a, _b;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-1.5 w-full max-w-[320px]", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "textarea",
      {
        ref,
...
function ChatMessageBubble({
  ...
  const reactions = inlineReactions ?? groupReactionsQuery.data ?? [];
  const content = message.content;
  const isPinned = message.pinned;
  const isDeleted = message.deleted;
  const isTextOnly = !content || content.kind === "text" || content.kind === "link";
  ...
  const handleReactionToggle = reactExports.useCallback(
    (emoji, hasReacted) => {
      setShowPicker(false);
      if (hasReacted) {
  ...
  const handlePickEmoji = reactExports.useCallback(
    (emoji) => {
      setShowPicker(false);
      const existing = reactions.find((r) => r.emoji === emoji);
      const hasReacted = (existing == null ? void 0 : existing.userIds.includes(currentUserId)) ?? false;
  ...
  const senderName = ((_a = message.senderProfile) == null ? void 0 : _a.displayName) ?? message.senderId;
  const senderInitials = ((_b = message.senderProfile) == null ? void 0 : _b.avatarInitials) ?? senderName.slice(0, 2).toUpperCase();
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        !isOwn && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-shrink-0 pt-4", children: showProfileLink ? /* @__PURE__ */ jsxRuntimeExports.jsx(
          Link$1,
          {
            to: "/profile/$userId",
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(AvatarBubble, { initials: senderInitials, size: "sm" })
          }
        ) : /* @__PURE__ */ jsxRuntimeExports.jsx(AvatarBubble, { initials: senderInitials, size: "sm" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            className: `flex flex-col gap-0.5 max-w-[72%] ${isOwn ? "items-end" : "items-start"}`,
            children: [
              !isOwn && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[13px] font-medium text-muted-foreground font-display ml-1 select-none", children: senderName }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  ref: pickerRef,
                  children: [
                    isPinned && !isDeleted && !editing && /* @__PURE__ */ jsxRuntimeExports.jsx(Pin, { className: "w-3 h-3 text-primary/50 flex-shrink-0 mb-1" }),
                    isDeleted ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "div",
                      {
                        className: `px-4 py-2.5 text-sm italic rounded-2xl border ${isOwn ? "rounded-br-sm border-primary/20 bg-primary/10 text-primary/50" : "rounded-bl-sm border-border bg-muted/40 text-muted-foreground/60"}`,
                        "data-ocid": "deleted-message",
                        children: roomType === "catalog" ? "Message removed by room creator" : "Message deleted"
                      }
                      ...
                      (content == null ? void 0 : content.kind) === "image" && /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "a",
                        {
                          ...
                          children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "img",
                            {
                              ...
                              alt: "Attachment",
                              className: `rounded-2xl border border-border/50 object-cover max-w-[260px] max-h-64 cursor-pointer hover:opacity-90 transition-smooth ${isOwn ? "rounded-br-sm" : "rounded-bl-sm"}`
                            }
                          )
                        }
                      ),
                      (content == null ? void 0 : content.kind) === "video" && // biome-ignore lint/a11y/useMediaCaption: video message playback
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "video",
                        {
                          controls: true,
                          src: content.video.url,
                          className: `rounded-2xl border border-border/50 max-w-[300px] ${isOwn ? "rounded-br-sm" : "rounded-bl-sm"}`,
                          "data-ocid": "video-message-bubble"
                        }
                      ),
                      (content == null ? void 0 : content.kind) === "audio" && /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "div",
                        {
                          className: `px-3 py-2 rounded-2xl border ${isOwn ? "rounded-br-sm bg-primary/10 border-primary/20" : "rounded-bl-sm bg-card border-border"}`,
                      ...
                      (content == null ? void 0 : content.kind) === "link" && /* @__PURE__ */ jsxRuntimeExports.jsx(
                        LinkMessageBubble,
                        {
                          link: content.link,
                          isOwn
                      ...
                      (!content || content.kind === "text") && message.text && /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "div",
                        {
                          className: `px-4 py-2.5 text-[15px] leading-relaxed break-words ${isOwn ? "message-bubble-self" : "message-bubble-other"}`,
                          "data-ocid": "text-message-bubble",
                          children: (content == null ? void 0 : content.kind) === "text" ? content.text : message.text
                        }
                      )
                    ] }),
                    !isDeleted && !editing && showActions && /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "button",
                      {
                        type: "button",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[13px] text-muted-foreground/50 select-none", children: formatTime(message.timestamp) }),
                    message.editedAt && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[13px] text-muted-foreground/40 select-none italic", children: "edited" }),
                    !isDeleted && !editing && showActions && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "div",
                      {
                        className: `flex items-center gap-0.5 ${isOwn ? "flex-row-reverse" : "flex-row"}`,
                        children: [
                          canPin && /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "button",
                            {
                              type: "button",
                              ...
                              children: isPinned ? /* @__PURE__ */ jsxRuntimeExports.jsx(PinOff, { className: "w-3 h-3" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Pin, { className: "w-3 h-3" })
                            }
                          ),
...
function normaliseGroupMessage(m) {
  return {
    id: m.id,
    senderId: m.senderId,
...
function normaliseCatalogMessage(m) {
  return {
    id: m.id,
    senderId: m.author,
    senderProfile: void 0,
    text: m.deletedByCreator ? "" : m.text,
    content: m.deletedByCreator ? void 0 : m.content,
    ...
    timestamp: typeof m.createdAt === "bigint" ? m.createdAt : BigInt(m.createdAt),
    deleted: m.deletedByCreator,
    editedAt: m.editedAt != null ? typeof m.editedAt === "bigint" ? m.editedAt : BigInt(m.editedAt) : void 0,
    pinned: m.pinned,
    reactions: m.reactions
  };
}
function normaliseFeedReply(r) {
  return {
    id: r.id.toString(),
...
function normalisePinned(roomType, pinned) {
  if (roomType === "group") {
    return pinned.map((p) => {
      var _a;
      return {
        id: p.messageId,
        text: p.message.text,
        senderName: ((_a = p.message.senderProfile) == null ? void 0 : _a.displayName) ?? p.message.senderId
      };
    });
  }
  if (roomType === "catalog") {
...
function useChatRoom({
  ...
  const isTypingRef = reactExports.useRef(false);
  const typingTimerRef = reactExports.useRef(null);
  const groupTypingMutateRef = reactExports.useRef(setGroupTyping.mutate);
  groupTypingMutateRef.current = setGroupTyping.mutate;
  const catalogTypingMutateRef = reactExports.useRef(setCatalogTyping.mutate);
  catalogTypingMutateRef.current = setCatalogTyping.mutate;
  const feedTypingMutateRef = reactExports.useRef(setFeedTyping.mutate);
  ...
  const messages = roomType === "group" ? (((_a = groupMessages.data) == null ? void 0 : _a.messages) ?? []).map(normaliseGroupMessage) : roomType === "catalog" ? (catalogMessages.data ?? []).map(normaliseCatalogMessage) : (feedReplies.data ?? []).map(normaliseFeedReply);
  const isLoading = roomType === "group" ? groupMessages.isLoading : roomType === "catalog" ? catalogMessages.isLoading : feedReplies.isLoading;
  const typingUsers = roomType === "group" ? groupTyping.data ?? [] : roomType === "catalog" ? catalogTyping.data ?? [] : feedTyping.data ?? [];
  const rawPinned = roomType === "group" ? groupPinned.data ?? [] : roomType === "catalog" ? catalogPinned.data ?? [] : [];
  const pinnedMessages = normalisePinned(
    roomType,
    rawPinned
  );
  const useMessageReactions = reactExports.useCallback(
    (_messageId) => {
      return [];
    },
    []
  );
  const uploadAndGetContent = reactExports.useCallback(
    async (file, kind) => {
  ...
  const sendText = reactExports.useCallback(
    async (text) => {
      if (!text.trim()) return;
      if (roomType === "group") {
  ...
  const sendMedia = reactExports.useCallback(
    async (file, caption = "") => {
  ...
  const sendVoice = reactExports.useCallback(
    async (blob, durationSecs) => {
  ...
  const sendVideo = reactExports.useCallback(
    async (blob, durationSecs, thumbnailBlob) => {
  ...
  const sendLink = reactExports.useCallback(
    async (url, text = "") => {
      const content = {
        kind: "link",
        link: { url }
  ...
  const addReaction = reactExports.useCallback(
    (messageId, emoji) => {
      if (roomType === "group") {
  ...
  const removeReaction = reactExports.useCallback(
    (messageId, emoji) => {
      if (roomType === "group") {
  ...
  const editMessage = reactExports.useCallback(
    (messageId, newText) => {
      if (roomType === "group") {
        editGroupMsg.mutate({
          messageId,
  ...
  const deleteMessage = reactExports.useCallback(
    (messageId) => {
      if (roomType === "group") {
  ...
  const pinMessage = reactExports.useCallback(
    (messageId) => {
      if (roomType === "group") {
        pinGroupMsg.mutate({
          messageId,
  ...
  const unpinMessage = reactExports.useCallback(
    (messageId) => {
      if (roomType === "group") {
